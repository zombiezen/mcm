...
// Annotations from go.capnp.
const (
	packageAnnotation    = uint64(0xbea97f1023792be0)
	importAnnotation     = uint64(0xe130b601260e44b5)
	docAnnotation        = uint64(0xc58ad6bd519f935e)
	tagAnnotation        = uint64(0xa574b41924caefc7)
	notagAnnotation      = uint64(0xc8768679ec52e012)
	customtypeAnnotation = uint64(0xfa10659ae02f2093)
	nameAnnotation       = uint64(0xc2b96012172f8df1)
)
